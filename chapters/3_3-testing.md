...
I set up another consultation with Dr. Aniwaa Owusu Obeng, an expert of
\glspl{pgx}.

### Setup

The consultation was set up as a roughly hour-long video call and initially
accompanied by presentation slides. To start off, I briefly reintroduced what
the Annotation Interface is and aims to accomplish, and explained how it fits
into the PharMe system. The testing was conducted on July 12, 2022.

Before starting the testing, I explained the aims, focus and process of the
testing and asked the expert to (1) think out loud and mention anything that is
unclear, and (2) focus on fundamental functionality, rather than suggestions to
improve the visual interface, during the testing process. In addition, I
reminded them that the testing is not meant to test them, but the Annotation
Interface as an application, to ensure a comfortable environment.
...
I chose the scenarios for increasing complexity and to progressively explore the
Annotation Interface's features:
